...
creator.gui.screen qml3f30189df46d42ca930c9eef5c157c66 "Parabank Welcome"
{
	creator.gui.form qmlad381e3b2e3a40e9a0dad0914377926f "Customer Login"
	{
		...
		"Forgot login info?"
			status = dontcare;
		creator.gui.textbox qmlcfc99fc835ce489e85788316781bf0d1 "field 2"
			type = String
			status = dontcare;
	}
...
creator.gui.screen qmld21c006fb79644c18062aa7ab646bb1a "Transaction Result"
{
	...
	"selenium:" = "";
	"selenium:" = "";
	] datatable = qml4366ef519ebb4e558523e7eaf2767c21
	{
	}
}
...
creator.gui.screen qml33aedf7d356244dc9191b2324de8ad6f "abc"
	deleted
{
}
creator.gui.screen qml48ca1315d2fc41c4bfa02602ba731a8c "Login"
	deleted
{
	creator.gui.form qml4a268714962949faadd5001df91738a7 "Credentials"
		deleted
	{
		creator.gui.textbox qml50ff38aa0913457d88bd5b0d101bf4cf "Username"
			type = String
			status = dontcare
			deleted;
		creator.gui.textbox qml45afbe3689e543aebb3a805f31dba24e "Password"
			type = String
			status = dontcare
			deleted;
	}
	creator.gui.button qml57741954e6524d8db7ba31aebf2d1750 "Submit"
		status = dontcare
		deleted;
	creator.gui.hyperlink qmlc7f6e861b2bb42859184dcb5359045ec "Forgot Login Info"
		status = dontcare
		deleted;
}
...
creator.externalinterface qml_1be731b0466b48f8834108051721b8cf
"IFeature special.xml"
	direction = in
	deleted;
creator.gui.screen qml64034f983ea740799b934acedf34a9e6 "unnamed"
	deleted
{
}
creator.customaction qml_8458dd3b859942f0bab01c797b1e1825
"Continue ActionFeature special.xml"
	interfaces = [ qml_1be731b0466b48f8834108051721b8cf
	deleted ]
	shortform = "IA"
	direction = in
	tokens = [ literal "" ]
...
creator.gui.screen qml26f3aeb0aef341f0ad068157e285a7c3 "Screen 1"
	deleted
{
}
creator.gui.screen qml09bef87a30f54802b44badc12cc3620c "Screen 2"
	deleted
{
}
creator.externalinterface qml_4bee547d22e341bd949f4e8c02acc4a9
"OFeature special.xml"
	direction = out
	deleted;
creator.gui.screen qml9651d5da0a184c288993d52efe3c1b6c "Parabank Landing"
	deleted
{
	creator.gui.hyperlink qml1c7208360411478d872da5d841b6309f "About Us"
		status = dontcare
		deleted;
	creator.gui.hyperlink qml025fa4878f5e405890ae0bc4bce1c771 "Home"
		status = dontcare
		deleted;
	creator.gui.form qml4285844afc7846468a9ab125064b6782 "Credentials Form"
		deleted
	{
		creator.gui.textbox qml25a0089026964169996f55249f6b9b12 "user name"
			type = String
			status = dontcare
			deleted;
		creator.gui.textbox qmld5f15c18a2394ddabd068196989b2ae4 "password"
			type = String
			status = dontcare
			deleted;
		creator.gui.button qml3766976fcbf845efa572645ea070d8e2 "Login"
			status = dontcare
			deleted;
	}
}
creator.customaction qml_78284da7c11f432e85152e6693fb1644
"feature US228929_Variation Injections"
	interfaces = [ qml_1be731b0466b48f8834108051721b8cf
	deleted ]
	shortform = "IA"
	direction = in
	tokens = [ literal "Setup (only required to get original tests) " reference
qml_e051411ddf11447186ddcfdb9ae34cbb reference
qml_dbc9091ac18e45e294a4475ee049d02a reference
qml_b419138258a642ee9832c585e68df828 ]
	deleted
{
	creator.primitivefield qml_e051411ddf11447186ddcfdb9ae34cbb
	"Variation Point 1"
		type = String
		deleted;
	creator.primitivefield qml_dbc9091ac18e45e294a4475ee049d02a
	"Variation Point 2"
		type = String
		deleted;
	creator.primitivefield qml_b419138258a642ee9832c585e68df828 "test case name"
		type = String
		deleted;
}